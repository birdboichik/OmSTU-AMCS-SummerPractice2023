...
#line hidden
        ...
        public Перемещение_ШатлаFeature(Перемещение_ШатлаFeature.FixtureData fixtureData, SpaceBattleBDD_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("ru"), "Features", "Перемещение_шатла", null, ProgrammingLanguage.CSharp, featureTags);
